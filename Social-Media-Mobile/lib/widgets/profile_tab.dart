...
import '../services/friend_service.dart'; // Để gọi API lấy danh sách
class ProfileTab extends StatefulWidget {
  final String currentUserId;
...
// --- 4. XỬ LÝ CLICK FOLLOWER/FOLLOWING (ĐÃ NÂNG CẤP) ---
  void _onTapFollowList(String title) {
    showModalBottomSheet(
        ...
        builder: (context) => DraggableScrollableSheet(
          initialChildSize: 0.7, // Mở lên 70% màn hình
          minChildSize: 0.4,
          maxChildSize: 0.95,
          builder: (_, scrollController) => Container(
            ...
            child: Column(
              children: [
                ...
                // Tiêu đề (Followers hoặc Following)
                Text(
                  title,
                ...
                // Danh sách User (Dùng FutureBuilder để tải dữ liệu thật)
                Expanded(
                  child: FutureBuilder<List<AppUser>>(
                    // Gọi API lấy danh sách từ FriendService
                    ...
                    builder: (context, snapshot) {
                        ...
                        return Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text("Chưa có ${title.toLowerCase()} nào.", style: const TextStyle(color: Colors.grey)),
                            ],
                          ),
                        );
                      }
                      ...
                      return ListView.builder(
                        controller: scrollController, // Quan trọng: Để cuộn mượt cùng BottomSheet
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            subtitle: Text(user.username.isNotEmpty ? "@${user.username}" : "No username", style: const TextStyle(fontSize: 12)),
                            // Nút hành động (Ví dụ: Nhắn tin)
                            trailing: Container(
                              height: 32,
                              padding: const EdgeInsets.symmetric(horizontal: 16),
                              decoration: BoxDecoration(
                            ...
                            onTap: () {
                              // Sau này bấm vào sẽ sang trang cá nhân người đó
                            },
                          );
                        },
                      );
